...
.then(
  	...
  	log(chalk.yellow("src/api/apilogin.js:9   url: '/login/loginbyemail'"))
  	log(chalk.yellow("src/api/apilogin.js:17   url: '/login/logout"))
  	log(chalk.yellow("src/api/apilogin.js:24   url: '/user/info'"))
  }
)
